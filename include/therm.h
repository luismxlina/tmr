...
esp_err_t therm_init(therm_t* thermistor, adc_channel_t channel, float series_resistance, float nominal_resistance, float nominal_temperature, float beta_coefficient);
